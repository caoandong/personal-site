...
code is the fundamental language / building block for agents; video generator is a compiler / renderer from code
* all content will be compressed into code from which we generate the images back


demand: short videos, short drama, short anime, games, highly personalized content

selling to agents vs selling to human: prefer selling to agents because the quantity of agents will grow and humans will increasing interacting with media / tool / code via agents; agents will increasingly act on human's behalf to accomplish high-level goals
building digital labor that can finish tasks end-to-end

question: will agents replace routers similar to how agent search replaces vector search?
...
* optimization loop that takes real user feedback and end-to-end optimize the video
