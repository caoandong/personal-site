...
we need new content format to create new platforms; maybe movie-based games? i think these might finally work; previously they require extremely high frequency interactions that makes it feel very tiresome; right now it might actually work;
...
* i want an agent that can produce long videos from the existing tools